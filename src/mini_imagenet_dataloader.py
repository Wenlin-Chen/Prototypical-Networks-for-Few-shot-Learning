...
class MiniImageNetDataLoader(object):
    def __init__(self, shot_num, way_num, episode_test_sample_num, shuffle_images = False):
        ...
        metatrain_folder = '../mini_imagenet/processed_images/train'
        metaval_folder = '../mini_imagenet/processed_images/val'
        metatest_folder = '../mini_imagenet/processed_images/test'
